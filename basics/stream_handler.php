...
if ($_POST) {
    $text = <<<LARGE_TEXT
In that case  \u{0000aa} when stream_get_contents/fread/fgets or other stream reading functions block indefinitely your script because they don't reached the limit of bytes to read use the socket_get_meta_data function to figure out the number of the bytes to read. 
